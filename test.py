...
data = ['date', 'stock_code_left', 'stock_open', 'stock_close', 'stock_high', 'stock_low', 'stock_volume', 'stock_amount',
        ...
        'sse_open', 'sse_close', 'sse_high', 'sse_low', 'sse_volume', 'sse_amount', 'sse_amplitude', 'sse_change_percent',
        'sse_change', 'sse_turnover_rate', 'sse_daily_return', 'sse_ma5', 'sse_ma20', 'sse_rsi', 'szse_open', 'szse_close',
        'szse_high', 'szse_low', 'szse_volume', 'szse_amount', 'szse_amplitude', 'szse_change_percent', 'szse_change',
        'szse_turnover_rate', 'szse_daily_return', 'szse_ma5', 'szse_ma20', 'szse_rsi', 'rate_rate', 'rate_change',
        'qvix_open', 'qvix_high', 'qvix_low', 'qvix_close', 'stock_code_right', 'revenue', 'total_operating_cost',
        'operating_profit', 'gross_profit', 'net_profit', 'basic_eps', 'rd_expenses', 'interest_income', 'interest_expense',
        'investment_income', 'cash_and_equivalents', 'accounts_receivable', 'inventory', 'net_fixed_assets',
        'short_term_borrowings', 'long_term_borrowings', 'total_equity', 'total_assets', 'total_liabilities',
        'net_cash_from_operating', 'net_cash_from_investing', 'net_cash_from_financing', 'net_increase_in_cce',
        'end_cash_and_cash_equivalents', 'gross_profit_margin', 'operating_profit_margin', 'net_profit_margin',
        'return_on_equity', 'return_on_assets', 'asset_turnover', 'inventory_turnover', 'receivables_turnover',
        'current_ratio', 'quick_ratio', 'debt_to_asset_ratio', 'revenue_growth_rate', 'net_profit_growth_rate']

if __name__ == "__main__":
    create_table()
    data = get_random_data_all()
    print(data)
