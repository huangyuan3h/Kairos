...
def train_days_model(model: LSTMAttentionTransformer, dataloader: DataLoader, criterion, optimizer, num_epochs: int,
                save_path: str, days=1):
    """
    训练模型。
    ...
    final_path = save_path.format(days)
